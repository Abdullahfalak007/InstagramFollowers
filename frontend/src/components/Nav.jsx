...
//             {dropdownOpen.instagram && (
//               <div className="dropdown-content">
//                 <NavLink to="/buy" onClick={() => setServiceType("instagram")}>
...
//             {dropdownOpen.tiktok && (
//               <div className="dropdown-content">
//                 <NavLink to="/buy" onClick={() => setServiceType("tiktok")}>
...
const Nav = () => {
  ...
  const { setServiceType } = useContext(ServiceContext);
  ...
  const handleServiceClick = (serviceType) => {
    ...
    setmenuIcons(false); // Close menu on mobile
  };
        ...
        <ul className="navbar-lists">
          ...
          >
            <NavLink
              ...
              className="navbar-link"
              activeclassname="active"
              onClick={() => handleServiceClick("tiktok")}
            >
              TikTok Services
            </NavLink>
            {dropdownOpen.tiktok && (
              <div className="dropdown-content">
                <NavLink to="/buy" onClick={() => handleServiceClick("tiktok")}>
          ...
          {/* Add more dropdowns for other services as needed */}
          <li>
            <NavLink
              to="/contact"
              className="navbar-link"
